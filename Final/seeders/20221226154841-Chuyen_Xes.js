    ...
    const items = []
      ...
      for(let i = 0; i <= 4; i++){
        for(let j = 0; j <7*14; j++ ){
          ...
          items.push({Gio_Bat_Dau:`${time}`,Tong_Thoi_Gian_Hanh_Trinh:totalTimeTravel,DiemDiId:randomDiemDi,DiemDenId:randomDiemDen,
          ...
          items.push({Gio_Bat_Dau:`${time}`,Tong_Thoi_Gian_Hanh_Trinh:totalTimeTravel,DiemDiId:randomDiemDen,DiemDenId:randomDiemDi,
          Ngay_Di:`${newDate(i).getFullYear()}-${newDate(i).getMonth() + 1}-${newDate(i).getDate()}`,Gia_Ve:randomGiaVe1,XeId:randomXeId,NhaXeId:randomNhaXeId}),
          ...
          items.push({Gio_Bat_Dau:`${time1}`,Tong_Thoi_Gian_Hanh_Trinh:totalTimeTravel,DiemDiId:randomDiemDi,DiemDenId:randomDiemDen,
          ...
          items.push({Gio_Bat_Dau:`${time1}`,Tong_Thoi_Gian_Hanh_Trinh:totalTimeTravel,DiemDiId:randomDiemDen,DiemDenId:randomDiemDi,
          Ngay_Di:`${newDate(i).getFullYear()}-${newDate(i).getMonth() + 1}-${newDate(i).getDate()}`,Gia_Ve:randomGiaVe2,XeId:randomXeId,NhaXeId:randomNhaXeId})
        }
      }
